...
`outputs/skill-workbench-pack.md` generates a project-tuned pack: rules sharpened to the team's history, scope globs matched to the repo, rubric dimension (பரிமாணம் — கோணம்)s extended with one domain-specific entry.
...
- [HKUDS/OpenHarness](https://github.com/HKUDS/OpenHarness) — reference how to build of a pack-equivalent
