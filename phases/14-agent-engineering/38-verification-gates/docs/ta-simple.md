...
- Define a verification gate as a deterministic function (சார்பு — உள்ளீட்டுக்கு வெளியீடு) over workbench artifacts.
...
- A `verify(task_id, artifacts) -> VerdictReport` pure function (சார்பு — உள்ளீட்டுக்கு வெளியீடு).
...
|------|----------------|------------------------|
| Verification gate | "The check that stops things" | Deterministic function (சார்பு — உள்ளீட்டுக்கு வெளியீடு) over workbench artifacts producing a pass/fail verdict |
