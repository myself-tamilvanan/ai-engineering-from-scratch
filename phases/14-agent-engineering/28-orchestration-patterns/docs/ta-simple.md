...
**2026 LangChain recommendation:** do supervision through direct tool calls quite than `create_supervisor`. Gives finer context engineering control — you decide exactly what each specialist sees.
...
This is orthogonal to the four patterns above but maps to topology: Flow is usually supervisor or hierarchical. Crew is usually supervisor with an LLM router.
