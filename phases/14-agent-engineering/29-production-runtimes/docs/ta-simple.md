...
- **Mastra** server adapters (Express, Hono, Fastify, Koa) for embedding (embedding — பொருளை எண்களாக மாற்றுதல்).
...
- Request-response endpoint (plain function (சார்பு — உள்ளீட்டுக்கு வெளியீடு)).
...
- **Queue** for batch (பத்தி — தொகுப்பு) / async / long-running.
...
- [AutoGen v0.4 (Microsoft Research)](https://www.microsoft.com/en-us/research/articles/autogen-v0-4-reimagining-the-foundation-of-agentic-ai-for-scale-extensibility-and-strength/) — actor-model fault isolation
