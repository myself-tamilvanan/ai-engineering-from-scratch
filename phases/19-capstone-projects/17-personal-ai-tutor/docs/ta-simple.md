...
- Memory: agentmemory-style persistent vector (வெக்டர் — எண் பட்டியல்) + episodic + semantic store
...
|------|-----------------|------------------------|
| Socratic policy | "Ask, do not dump" | Tutor asks a leading question quite than giving the answer |
...
- [FSRS algorithm (அல்கோரிதம் — வழிமுறை)](https://github.com/open-spaced-repetition/fsrs4anki) — spaced-repetition scheduler
