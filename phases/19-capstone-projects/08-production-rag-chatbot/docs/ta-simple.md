...
chunks + summaries + role-labels + jurisdiction tags
      |
      v
pgvector (வெக்டர் — எண் பட்டியல்) + pgvectorscale  +  BM25 (Tantivy)
      |
...
- vector (வெக்டர் — எண் பட்டியல்) DB: pgvector + pgvectorscale under 50M vectors. Qdrant Cloud otherwise
...
2. **Index.** Dense embedding (embedding — பொருளை எண்களாக மாற்றுதல்)s (Voyage-3 or Nomic-embed-v2) into pgvector (வெக்டர் — எண் பட்டியல்) + pgvectorscale. BM25 side-index via Tantivy. Role and jurisdiction filters as payload.
...
|------|-----------------|------------------------|
| Prompt caching | "Cached system + context" | Claude/OpenAI feature (பண்பு — தகவல் நெடுவரிசை): cached prefix tokens discounted 60-90% on hit |
