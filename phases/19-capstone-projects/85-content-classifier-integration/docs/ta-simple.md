...
| router | a switch | a function (சார்பு — உள்ளீட்டுக்கு வெளியீடு) from verdict list to action (block, redact, warn, log) |
