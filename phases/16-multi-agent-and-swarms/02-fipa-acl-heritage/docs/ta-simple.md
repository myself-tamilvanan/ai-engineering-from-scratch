...
- **Ontology extra work.** FIPA required a shared ontology to parse `content`. Agreeing on ontologies is a years-long standards process. The web just used HTTP + JSON.
...
Looser intent semantics for easier how to build. That is the exact trade.
