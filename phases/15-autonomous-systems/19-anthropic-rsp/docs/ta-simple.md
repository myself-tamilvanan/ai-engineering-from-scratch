...
This is the capability level RSP v3.0 names as the important next threshold. Specifically: a model that could automate a large fraction of AI research at competitive cost. Once Anthropic believes a model crosses it, they must publish an affirmative case identifying misalignment risks and mitigations before continued scaling.
...
- AI R&D-4 threshold mitigations are described as "affirmative case" quite than specific measures.
...
| AI R&D-4 | "Research-automation threshold" | Capability to automate large AI research at competitive cost |
