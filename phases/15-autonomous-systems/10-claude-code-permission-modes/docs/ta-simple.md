...
- `max_turns` — total iteration (மறுயுதல் — மீண்டும் செய்தல்)s in a session.
...
| Research preview | "Not GA" | Anthropic framing for feature (பண்பு — தகவல் நெடுவரிசை)s whose failure mode is still being mapped |
...
- [Anthropic — Claude Code product page](https://www.anthropic.com/product/claude-code) — feature (பண்பு — தகவல் நெடுவரிசை) surface and Auto Mode announcement.
