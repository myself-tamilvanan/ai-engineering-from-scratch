...
3. Read Burns et al. 2023 Section 4.3 (NLP tasks). Reproduce the "confidence auxiliary loss" simple idea: when the strong model is more confident than the weak labels, who wins?
