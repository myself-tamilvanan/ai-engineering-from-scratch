...
arXiv:2401.13935 (January 2024). Traditional counterfactuals require interventions on the sensitive attribute — "would the decision change if this person had been a different gender." Legally, this is problematic: protected attributes cannot be intervened on in classification (வகைப்படுத்தல் — பிரிவுகளாக தொகுத்தல்) law.

Backtracking counterfactuals flip the direction: instead of intervening on the attribute, ask what combination of the individual's actual feature (பண்பு — தகவல் நெடுவரிசை)s would have produced the counterfactual outcome. This sidesteps the legal objection.
...
2. Implement the Dwork et al. 2012 individual-fairness metric using L2 on non-sensitive feature (பண்பு — தகவல் நெடுவரிசை)s. Report how many pairs violate Lipschitz with constant L=1.

3. Read Kusner et al. 2017. Construct a simple two-feature (பண்பு — தகவல் நெடுவரிசை) causal DAG for resume scoring and identify the counterfactual-fairness condition it implies.
