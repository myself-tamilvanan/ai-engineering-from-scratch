...
- **General-Purpose AI (GPAI) models**. Applied 2 August 2025. All GPAI providers have obligations. systemic-risk GPAI (>1e25 FLOP training compute) have extra obligations.
...
12 commitments total. A Signatory Taskforce chaired by the AI Office manages how to build. Enforcement begins 2 August 2026. until then, good-faith compliance is accepted.
...
Renamed from AI Safety Institute. The rebrand narrows scope: drops algorithm (அல்கோரிதம் — வழிமுறை)ic bias and free-speech framings. focuses on frontier capability security. Open-sourced the Inspect evaluation tool (May 2024). Collaborates with Redwood (Lesson 10) on control safety cases.
...
Competing regulatory philosophies. Deployers in multiple jurisdictions have to comply with the strictest, which in 2026 is usually the EU AI Act.
...
This lesson produces `outputs/skill-regulatory-map.md`. Given a deployment description, it maps the applicable jurisdictions, the tier classification (வகைப்படுத்தல் — பிரிவுகளாக தொகுத்தல்)s in each, the per-jurisdiction obligations, and the deadline structure.
...
| GPAI | "general-purpose AI" | Large foundation models. systemic-risk subset has extra obligations |
...
| Systemic-risk GPAI | "the 1e25 FLOP threshold" | extra obligations tier. estimated 5-15 companies bound |
