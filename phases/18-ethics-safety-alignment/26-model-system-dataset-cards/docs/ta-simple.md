...
- **Microscopic.** Detailed feature (பண்பு — தகவல் நெடுவரிசை)-level documentation for auditors.

Boundary-object framing: different readers extract different information from the same document.

### System Cards

Scope: end-to-end AI system including model + safety stack + deployment context. Sections usually include:
...
| Boundary object | "different readers, one doc" | Data Cards framing: same document serves many different audiences |
