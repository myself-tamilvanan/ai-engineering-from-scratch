...
- Define indirect prompt injection and describe three common delivery vector (வெக்டர் — எண் பட்டியல்)s.
...
### Three delivery vector (வெக்டர் — எண் பட்டியல்)s
...
Nasr et al. (October 2025) tested 12 published IPI defenses with adaptive attacks (gradient (சாய்வு — மாற்றத்தின் दिशा) search, RL policies, random search, 72-hour human red-team). Every defense that originally reported near-zero ASR was broken to >90% ASR.

The methodological lesson: publish a defense only with adaptive-attack evaluation. Static-attack benchmarks are not evidence of strength. the attacker gets to know the defense.
...
| Adaptive attack | "gradient (சாய்வு — மாற்றத்தின் दिशा) / RL red-team" | Attack that knows the defense and optimizes against it. required for honest evaluation |
