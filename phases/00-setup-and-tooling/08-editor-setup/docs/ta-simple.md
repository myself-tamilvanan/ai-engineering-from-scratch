...
- **Type checking on basic**: Catches wrong argument types before you run. Saves debugging time on tensor (டென்சர் — பல வடிவ எண் வரிசை) shape mismatches and wrong API parameter (பாரமீட்டர் — கட்டுப்பாடு)s.
