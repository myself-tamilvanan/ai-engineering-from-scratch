...
- **Train**: The model learns from this (usually 80%)
- **Validation**: You check progress during training (usually 10%)
- **Test**: Final evaluation after training is done (usually 10%)
...
git lfs install
git lfs track "*.bin"
git lfs track "*.safetensor (டென்சர் — பல வடிவ எண் வரிசை)s"
...
|---------|---------|------|----------------|
| IMDB | Tokenization, classification (வகைப்படுத்தல் — பிரிவுகளாக தொகுத்தல்) | 84 MB | Text classification basics |
| WikiText | Language modeling | 181 MB | Next-token prediction |
| SQuAD | QA systems | 35 MB | Question answering, spans |
| Common Crawl (subset) | embedding (embedding — பொருளை எண்களாக மாற்றுதல்)s | Varies | Large-scale text processing |
...
| Parquet | "Compressed CSV" | A columnar file format optimized for analytical queries and storage speed |
