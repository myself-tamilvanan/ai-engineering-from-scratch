...
Security for LLM services has to address all three vector (வெக்டர் — எண் பட்டியல்)s. Vault-backed credentials. PII scrubbing. Network egress filtering. Audit logs.
...
- Whitelist: `api.openai.com`, `api.anthropic.com`, vector (வெக்டர் — எண் பட்டியல்) DB endpoints, vault endpoints.
