...
- Quantify when LMCache CPU-DRAM helps (KV > HBM) vs adds extra work (KV small enough to fit HBM).
...
- Low KV footprint (short prompts, low concurrency): all configs match baseline, LMCache adds ~3-5% extra work.
...
- Small HBM pressure — you pay extra work without benefit.
...
- Small HBM pressure: 3-5% extra work without benefit.
...
5. Argue whether the vLLM 0.11.0 asynchronous path is "free" — where does the extra work hide?
...
- [LMCache GitHub](https://github.com/LMCache/LMCache) — Connector how to build.
