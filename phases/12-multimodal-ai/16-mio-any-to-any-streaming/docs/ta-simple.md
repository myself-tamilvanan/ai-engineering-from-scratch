...
Total: ~48k vocabulary. The input embedding (embedding — பொருளை எண்களாக மாற்றுதல்) and output projection span all of it.
...
3. Your vocabulary has 32k text + 4k image + 4k speech. Add 8k music and ~10 separators. What is the embedding (embedding — பொருளை எண்களாக மாற்றுதல்)-matrix (மேட்ரிக்ஸ் — எண் மேஜை) parameter (பாரமீட்டர் — கட்டுப்பாடு) cost at hidden dim 4096?
