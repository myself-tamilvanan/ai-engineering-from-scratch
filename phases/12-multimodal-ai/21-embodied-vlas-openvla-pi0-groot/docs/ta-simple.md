...
1. Action spaces are continuous (joint angles, forces) and high-dimension (பரிமாணம் — கோணம்)al (7-DOF arm + 3-DOF gripper = 10 dims at 30 Hz).
...
RT-2's ratio: ~1:1. OpenVLA: ~0.5:1 web-to-robot. π0: similar. The precise ratio is a hyperparameter (பாரமீட்டர் — கட்டுப்பாடு) to tune per dataset size.
